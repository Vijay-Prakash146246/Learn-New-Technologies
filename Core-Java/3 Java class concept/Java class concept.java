...
Different ways to createobject:-
...
In above application when we create object by using new keyword “Test t = new Test()” then compiler is searching for “Test()” constructor inside the class 
since not available hence compiler generate default constructor at the time of compilation.
...
Example:-
 Inside the class if we are not declaring at least one constructor (either 0-arg or parameterized) then compiler generate 0-arg constructor with empty implementation is 
...
C:\Users\HP\Desktop\Learn New Technologies\Learn-New-Technologies\Core-Java\3 Java class concept>javac Test.java
Test.java:9: error: constructor Test in class Test cannot be applied to given types;
                Test t1=new Test(); //error : inside the class no 0-arg constructor
                        ^
  required: int
  found: no arguments
...
{ 
	...
	{ 
		...
		Test t1;
		//write some different code here 
		t1=new Test();
		t1.m1();
	}
}
...
//ex: Solution : only one time we are creating object.
class Test
{ 
	A a; //ins var
	void m1()
...
ex-1:-Call the methods by using method name but call t contructor using this keyword.
class Test
{ 
	Test()
	{ 
...
/*
C:\Users\HP\Desktop\Learn New Technologies\Learn-New-Technologies\Core-Java\3 Java class concept>java Employee
****Employee details****
Emp eid :-->0
Emp name :-->null
Empesal :-->0.0
...
//Problem :-
 In above example when we create more than one object for every object same constructor executed it initializes the same values so to overcome this problem use parameterized 
constructor to initialize different value to different objects.
...
class Employee
{
	...
	{ 
		...
		e1.display();
		new Employee(111,"ratan",60000).display();
		Employee e2 = new Employee(222,"anu",70000);
		e2.display();
		new Employee(222,"anu",70000).display();
	}
}
/*
C:\Users\HP\Desktop\Learn New Technologies\Learn-New-Technologies\Core-Java\3 Java class concept>javac Test.java
...
C:\Users\HP\Desktop\Learn New Technologies\Learn-New-Technologies\Core-Java\3 Java class concept>java Emp
Emp id=111
Emp name=ratan
Emp id=111
Emp name=ratan
...
C:\Users\HP\Desktop\Learn New Technologies\Learn-New-Technologies\Core-Java\3 Java class concept>java Test
instance block:logics-1
instance block:logics-2
0-arg cons
instance block:logics-1
instance block:logics-2
1-arg cons
